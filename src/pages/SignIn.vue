<template lang="html">
  <div class="sign-in">
    <b-modal :centered="true" :hide-header-close="true" ref="sign-in-modal" no-close-on-backdrop no-close-on-esc
             hide-footer title="Sign-In">
      <b-form-group
          label="User name:"
          label-for="user-name"
      >
...
import {SIGNIN_AUTH} from "@/store/modules/auth/types";
...
export default {
  ...
  methods: {
    ...mapActions("auth", {signInAuth: SIGNIN_AUTH}),
